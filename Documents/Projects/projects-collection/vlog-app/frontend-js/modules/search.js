...
export default class Search {
    // 1. Select DOM elements and keep track of any data
    ...
    renderResultsHTML(posts) {
        if (posts.length) {
            ...
            this.resultsArea.innerHTML = `<p class="alert alert-danger text-center shadow-sm">Sorry, we could not find ay results for that search.</p>`
        }
        this.hideLoaderIcon()
